...
public class ModelTest {
	...
	@Test
	public void treasureリストにお金がランダムのtreasureクラスを複数生成する() {
		Model model = new Model();
		model.createTreasures();
		assertNotEquals(model.getTreasures().get(0).getMoney(), model.getTreasures().get(1).getMoney());
	}
